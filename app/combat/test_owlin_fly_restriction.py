...
def test_owlin_fly_available_without_medium_or_heavy_armor(monkeypatch) -> None:
...
def test_owlin_fly_blocked_in_medium_armor(monkeypatch) -> None:
    calls: list[dict[str, Any]] = []
    ...
    chars_by_uid = {
        1: SimpleNamespace(
            ...
            stats={
                "dex": 60,
                "_inv": [{"id": "armor1", "def": "test_medium_armor", "name": "Тестовый средний доспех", "qty": 1}],
                "_equip": {"body": "armor1"},
            },
            inventory=[{"id": "armor1", "def": "test_medium_armor", "name": "Тестовый средний доспех", "qty": 1}],
            equip={"body": "armor1"},
            race_features={
                "speeds": {
                    "walk_ft": 30,
