...
def test_satyr_ram_uses_shared_combat_attack_profile(monkeypatch) -> None:
    session_id = "test_satyr_ram_uses_shared_combat_attack_profile"
    ...
    state.combatants["pc_1"] = Combatant(
        ...
        race_features={
            ...
            "natural_weapons": [
                {"key": "ram", "kind": "unarmed", "damage_dice": "1d4", "damage_type": "bludgeoning", "ability": "str"}
            ],
        },
    )
...
def test_leonin_claws_regression_still_works(monkeypatch) -> None:
    session_id = "test_leonin_claws_regression_still_works_after_satyr_ram"
    state = start_combat(session_id)
    state.combatants["pc_1"] = Combatant(
        key="pc_1",
        name="Leonin",
...
def test_non_satyr_unarmed_attack_regression_stays_bludgeoning(monkeypatch) -> None:
    session_id = "test_non_satyr_unarmed_attack_regression_stays_bludgeoning"
    state = start_combat(session_id)
    state.combatants["pc_1"] = Combatant(
        key="pc_1",
        name="Commoner",
