...
def setup_basic_create_mocks(monkeypatch, *, session_title: str) -> None:
    sess = SimpleNamespace(id=uuid.uuid4(), title=session_title, settings={}, is_active=False)
...
def kenku_base_payload() -> dict[str, Any]:
    return {
...
def loxodon_base_payload() -> dict[str, Any]:
    return {
        "session_id": "test-session",
        "uid": 711,
        "name": "Loxodon Hero",
...
def firbolg_base_payload(
    *,
    session_id: str = "test-session",
    uid: int = 77701,
    name: str = "Firbolg Hero",
) -> dict[str, Any]:
    return {
