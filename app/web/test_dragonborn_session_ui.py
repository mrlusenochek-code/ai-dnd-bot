...
def test_dragonborn_ui_texts_present_in_session_template() -> None:
    ...
    assert "Оружие дыхания: ${draconicDamageRu || \"—\"}, ${draconicAreaText || \"зона не указана\"}, спасбросок ${draconicSaveRu || \"—\"}, урон ${breathDiceRu || \"—\"}, статус: ${breathWeaponStatus}, перезарядка: ${breathRechargeRu}" in session_template
