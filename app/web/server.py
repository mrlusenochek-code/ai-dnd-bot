...
CHAT_COMBAT_ACTION_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    ...
    ("combat_escape", re.compile(r"(убег|сбег|побег|бегу прочь|ретир|свалив|уход из боя|выхожу из боя|спасаюсь)", re.IGNORECASE)),
...
def _combat_narration_mentions_action(text: str, action: str) -> bool:
    ...
    if action == "combat_escape":
        return bool(re.search(r"(убег|сбег|побег|ретир|бегу прочь|спасаюс|уход из боя|выхожу из боя|разрыв дистанц)", lowered))
