...
def test_fairy_fly_speed_available_without_restricted_armor() -> None:
    race_features = {
        "speeds": {
            "walk_ft": 30,
            "fly_ft": 30,
...
def test_fairy_fly_speed_blocked_in_medium_armor(monkeypatch) -> None:
    race_features = {
        "speeds": {
            "walk_ft": 30,
            "fly_ft": 30,
...
def test_fairy_fly_speed_blocked_in_heavy_armor(monkeypatch) -> None:
    race_features = {
        "speeds": {
            "walk_ft": 30,
            "fly_ft": 30,
...
def test_non_fairy_without_flight_is_unchanged() -> None:
    available, armor_cat = fly_speed_available_by_armor(
