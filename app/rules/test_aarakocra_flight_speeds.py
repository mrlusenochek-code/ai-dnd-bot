...
def test_aarakocra_fly_speed_available_without_restricted_armor() -> None:
    race_features = {
        "speeds": {
            "walk_ft": 25,
            "fly_ft": 50,
    ...
    assert race_features["speeds"]["fly_ft"] == 50


def test_aarakocra_fly_speed_blocked_in_medium_armor(monkeypatch) -> None:
    race_features = {
        "speeds": {
            "walk_ft": 25,
            "fly_ft": 50,
...
def test_aarakocra_fly_speed_blocked_in_heavy_armor(monkeypatch) -> None:
    race_features = {
        "speeds": {
            "walk_ft": 25,
            "fly_ft": 50,
...
def test_non_aarakocra_without_flight_is_unchanged() -> None:
    available, armor_cat = fly_speed_available_by_armor(
